...
[numthreads(8, 8, 1)] void main(uint3 dispatchID : SV_DispatchThreadID)
{
    ...
    float3 color = Color::IrradianceToGamma(ssrDiffuse.xyz * Color::IrradianceToLinear(albedo.xyz) * SharedData::ssrSettings.DiffuseMult + Color::IrradianceToLinear(originalColor.xyz));
