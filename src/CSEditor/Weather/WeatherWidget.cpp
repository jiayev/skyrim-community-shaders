...
void WeatherWidget::DrawWidget()
{
	...
	if (ImGui::BeginTabBar("WeatherSettingsTabs", ImGuiTabBarFlags_None)) {
		...
		if (ImGui::BeginTabItem(T(TKEY("scene_settings"), WeatherTab::kSceneSettings), nullptr, sceneFlags)) {
...
void WeatherWidget::NavigateToFeatureSetting(const std::string&, const std::string&)
{
	activeTabOverride = WeatherTab::kSceneSettings;
}
