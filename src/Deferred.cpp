...
void Deferred::DeferredPasses()
{
	...
	if (!skipDeferredComposite) {
		...
		globals::features::physicalSky.BindCompositeResources();
...
{
	if ((globals::features::raytracing.IsPathTracing() && !globals::features::raytracing.HasPathTracingDepth()) ||
		!MediumCompositeEnabled() ||
