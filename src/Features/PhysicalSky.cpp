...
void PhysicalSky::Reset()
{
	...
	cbData = {
		...
		.rayleighScatter = (wideGamut ? settings.rayleighScatterAP1 : settings.rayleighScatter) * 1e-3 * Util::Units::GAME_UNIT_TO_KM,
		...
		.ozoneAbsorption = (wideGamut ? settings.ozoneAbsorptionAP1 : settings.ozoneAbsorption) * 1e-3 * Util::Units::GAME_UNIT_TO_KM,
