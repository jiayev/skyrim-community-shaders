...
namespace ACES2
{
	...
	// Compute all ACES 2.0 parameters for the given peak luminance and HDR mode
	// SDR (hdr=false): sRGB/Rec.709 limiting gamut, peak=100 nits
	// HDR (hdr=true):  P3-D65 limiting gamut, peak from HDR settings
